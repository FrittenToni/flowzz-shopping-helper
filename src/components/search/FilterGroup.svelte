<script lang="ts">
  ...
  const uniqueCultivars = [...new Set(cannabisStrains.map(strain => formatStrainName(strain.strain_name)))];
...
<div class="filter-group">
  <div class="filter-item">
      ...
      <input type="number" bind:value={priceMin} min="0" placeholder="Min Price" on:input={handleFilterChange}/>
      <input type="number" bind:value={priceMax} min="0" placeholder="Max Price" on:input={handleFilterChange}/>
  </div>
  <div class="filter-item">
      <label>THC Range:</label>
      <input type="number" bind:value={thcMin} min="0" max="100" placeholder="Min THC" on:input={handleFilterChange}/>
      <input type="number" bind:value={thcMax} min="0" max="100" placeholder="Max THC" on:input={handleFilterChange}/>
  </div>
  <div class="filter-item">
      <label>Review Score:</label>
      <input type="number" bind:value={ratingMin} min="0" max="5" step="0.1" placeholder="Min Score" on:input={handleFilterChange}/>
  </div>
  <div class="filter-item">
      <label>Min Reviews:</label>
      <input type="number" bind:value={scoreCountMin} min="0" placeholder="Min Score Count" on:input={handleFilterChange}/>
  </div>
  <div class="filter-item">
      <label>Sort By:</label>
  ...
  <div class="filter-item checkbox-item">
      <label class="checkbox-container">
          <input type="checkbox" bind:checked={showAvailableOnly} on:change={handleFilterChange}/>
          Show Available Only
      </label>
  </div>
  <div class="filter-item">
